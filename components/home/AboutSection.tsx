            ...
            <div className={styles.aboutInfo}>
              ...
              <div className={styles.aboutInfoRight}>
                <p>
                  ...
                  Slavic countries. We will cross the entire country, from
                  Zagreb to Dubrovnik, visit amazing cities, and see stunning
                  nature.
                </p>
                <p>
                  The program is carefully thought out, there are no more than
                  10 people in each group plus an English-speaking guide.
                  Comfortable vans and nights in 3*+ hotels are included in the
                  price.
                </p>
              </div>
            </div>
        ...
        <article className={styles.contactInfo}>
          <div className={styles.contactInfoInner}>
            ...
            <div className={`${styles.start} ${styles.contactCard} `}>
              ...
              <p>
                If necessary, we help you apply for a visa to Croatia, as well
                as advise what things you should take with you.
              </p>
            </div>
          </div>
        </article>
